        ...
        do {
            ...
            if (maskapai == '1') {
                ...
                for (int i = 0; i < Ticket.length; i++) {
                    Ticket[i] = new Lion_Air(jml, city_2, plane_no, seat, " ", " ", " ", ' ', date_1, date_2, city_1);
                    Ticket[i].InputData(i, jml, city_1, city_2, Ticket.length, date_1, date_2, acak, plane_no);
                }
                ...
                for (int i = 0; i < Ticket.length; i++) {
                    Ticket[i] = new Citilink(jml, city_2, plane_no, seat, " ", " ", " ", ' ', date_1, date_2, city_1);
                    Ticket[i].InputData(i, jml, city_1, city_2, Ticket.length, date_1, date_2, acak, plane_no);
                }
